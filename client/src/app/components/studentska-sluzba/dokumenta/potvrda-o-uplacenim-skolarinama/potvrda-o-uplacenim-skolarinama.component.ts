...
@Component({
  selector: 'app-potvrda-o-uplacenim-skolarinama',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    TabelaStudenataComponent
  ],
  templateUrl: './potvrda-o-uplacenim-skolarinama.component.html',
  styleUrl: './potvrda-o-uplacenim-skolarinama.component.css'
})
export class PotvrdaOUplacenimSkolarinamaComponent implements OnInit{
  form!: FormGroup;
