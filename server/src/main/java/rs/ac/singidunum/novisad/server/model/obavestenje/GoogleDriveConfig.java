...
public class GoogleDriveConfig {
    ...
    private Credential getCredentials(HttpTransport httpTransport) throws IOException {
        GoogleCredential credential = GoogleCredential.fromStream(new FileInputStream("src/main/java/rs/ac/singidunum/novisad/server/model/obavestenje/client_secret_1010100917967-235ij32pnd2mlds02reg93soadn252im.apps.googleusercontent.com.json"))
